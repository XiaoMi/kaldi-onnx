...
class Node(object):
  ...
  def inputs(self, inputs):
    if isinstance(inputs, six.string_types):
      ...
      kaldi_check(False, "inputs(%s) should be a list or a string!" % inputs)
  ...
  def outputs(self, outputs):
    if isinstance(outputs, six.string_types):
      ...
      kaldi_check(False, "outputs(%s) should be a list or a string!" % outputs)
  ...
  def inference_index(self, indexes_by_name, nodes_by_name):
    ...
    if input_name in indexes_by_name:
      ...
      kaldi_check(input_name in nodes_by_name, "Cannot find node: %s" % input_name)
